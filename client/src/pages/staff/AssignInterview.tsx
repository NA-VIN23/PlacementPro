                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" className="w-full pl-9 pr-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20" placeholder="Search student name..." />
                                </div>
                            </div>

                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Interview Type</label>
                                <select className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20 bg-white">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="time" className="w-full pl-9 pr-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20" />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="text" className="w-full pl-9 pr-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20" placeholder="Zoom / Google Meet URL" />
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className={cn(
                                "w-full py-3 text-white font-bold rounded-xl transition-all shadow-lg shadow-brand-500/30",
                                scheduled ? "bg-green-600 hover:bg-green-700" : "bg-brand-600 hover:bg-brand-700"
                            )}
                        >
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <button className="text-sm font-medium text-brand-600 hover:text-brand-700">View Calendar</button>
                        </div>
                            ...
                            {[
                                ...
                                <div key={idx} className="p-4 hover:bg-slate-50 transition-colors flex items-center justify-between group">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-slate-800 group-hover:text-brand-700 transition-colors">{item.student}</h4>
