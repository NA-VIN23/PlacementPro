...
import { Youtube, Globe, ArrowRight, ChevronLeft, Sigma, BrainCircuit, MessageSquareQuote, Terminal, Code2, Database, Layers, Network, GitBranch, Cpu } from 'lucide-react';
