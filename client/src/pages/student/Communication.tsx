...
export const StudentCommunication: React.FC = () => {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            {/* Hero Card */}
            <div className="rounded-3xl bg-gradient-to-br from-slate-900 via-purple-900/40 to-slate-900 overflow-hidden relative min-h-[350px] flex items-center p-8 md:p-12 border border-purple-500/20">
                ...
                <div className="relative z-10 max-w-2xl space-y-6">
                    <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-500/20 border border-purple-400/30 text-purple-300 text-sm font-semibold tracking-wide backdrop-blur-sm">
                        <Mic className="w-4 h-4" />
                        Voice-Powered AI Interview
                    </span>
                    <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
                        Practice with <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">AI Interviewer</span>
                    </h2>
                    ...
                    <div className="flex flex-wrap gap-4">
                        <button
                            ...
                            className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white rounded-xl font-bold text-lg transition-all flex items-center gap-3 shadow-lg shadow-purple-500/25 group"
                        >
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                        {['🎤 Voice-based', '🤖 AI-powered', '📝 Personalized questions', '⚡ Real-time feedback'].map((feature, i) => (
                            <span key={i} className="px-3 py-1.5 bg-slate-800/50 rounded-lg text-slate-300 text-sm border border-slate-700/50">
                                {feature}
                            </span>
                        ))}
                    </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                    ...
                    <button className="text-purple-600 text-sm font-medium hover:underline">View All History</button>
                </div>
